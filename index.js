...
async function startnaimi() {
    const naimi = naimiConnect({
        ...
        browser: ['hamzah Multi Device','Safari','1.0.0'],
        auth: state,
        version: getVersionWaweb() || [2, 2204, 13]
    })
    console.log(color('[HAMZAH MD]', 'cyan'), color(`
██╗░░██╗░█████╗░███╗░░░███╗███████╗██╗░░██╗
██║░░██║██╔══██╗████╗░████║╚════██║██║░░██║
███████║███████║██╔████╔██║░░███╔═╝███████║
██╔══██║██╔══██║██║╚██╔╝██║██╔══╝░░██╔══██║
██║░░██║██║░░██║██║░╚═╝░██║███████╗██║░░██║
╚═╝░░╚═╝╚═╝░░╚═╝╚═╝░░░░░╚═╝╚══════╝╚═╝░░╚═╝`, 'red'))
console.log(color('[HAMZAH MD]', 'cyan'), color('OWNER SEDANG ONLINE SEKARANG!', 'yellow'))

	console.log(color('[HAMZAH MD]', 'cyan'), color('SELAMAT DATANG OWNER ><', 'yellow'))
	
	console.log(color('======================', 'fuchsia'),color('\n[hamzah MD V1]', 'pink'),color('\nTHANKS TO: \n➸ ALLAH SWT\n➸ mastah.\nPenyedia scrape dan module lainnya', 'yellow'),color('\n======================', 'fuchsia'))
	console.log(color('\nADA SARAN ATAU MASUKAN WA : +6285336889508', 'aqua'))
    store.bind(naimi.ev)
...
mediaType:2,
thumbnail: ppusernya,
sourceUrl: `https://www.instagram.com/hamzahxou`,
